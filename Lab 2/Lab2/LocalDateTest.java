...
public class LocalDateTest {
    ...
    static LocalDate parse() {
         ...
         *
         */
        String toBeParsed = "2015-06-18";
        return LocalDate.parse(toBeParsed);
    }
    ...
    static LocalDate with() {
         ...
         */
        LocalDate ldt1 = ld.withYear(2015);
        return ldt1;
    }
    ...
    static LocalDate withAdjuster() {
         ...
         */
        LocalDate ldt1 = ld.with(TemporalAdjusters.firstDayOfNextYear());
        return ldt1;
    }
